...
public class ParkingFacilityParser {
    ...
    public List<ParkingFacility> parse(String data) throws JAXBException {
        ...
        //JAXBContext jaxbContext = com.sun.xml.bind.v2.ContextFactory.createContext(new Class[]{D2LogicalModel.class, ObjectFactory.class},  null); 
        //JAXBContext jaxbContext = factory.createContext(new Class[]{D2LogicalModel.class, ObjectFactory.class}, null); 
        JAXBContext jaxbContext = JAXBContext.newInstance(new Class[]{D2LogicalModel.class, ObjectFactory.class}, Collections.singletonMap("javax.xml.bind.context.factory", "com.sun.xml.bind.v2.ContextFactory"));
